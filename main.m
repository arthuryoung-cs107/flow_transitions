...
figs(1) = AYfig.figure(fig_specs{1});
  set(gca, 'YScale', 'log')
  set(gca, 'XScale', 'log')
  ylim([1e-8, 1e-3]);
  xlim([0.0628  100]);
...
figs(2) = AYfig.figure(fig_specs{2});
...
figs(3) = AYfig.figure(fig_specs{3});
...
figs(4) = AYfig.figure(fig_specs{4});
  tile_object = tiledlayout(1, 2);
  ax1 = nexttile;
  box on;
  set(gca, 'YScale', 'log')
...
figs(5) = AYfig.figure(fig_specs{5});
  ax1 = axes('Position', ax21(1, :));
  set(gca, 'YScale', 'log')
  set(gca, 'XScale', 'log')
  hold(ax1, 'on');
...
figs(6) = AYfig.figure(fig_specs{6});
...
figs(7) = AYfig.figure(fig_specs{7});
  tile_object = tiledlayout(1, 2);
  ax1 = nexttile;
  box on;
  set(gca, 'YScale', 'log')
...
sub_figs(1) = AYfig.figure(subfig_specs{1});
  tile_object = tiledlayout(1, 2);
  ax1 = nexttile;
  box on;
  set(gca, 'YScale', 'log')
...
sub_figs(2) = AYfig.figure(subfig_specs{2});
  tile_object = tiledlayout(1, 2);
  ax1 = nexttile;
  box on;
  hold(ax1, 'on');
...
sub_figs(3) = AYfig.figure(subfig_specs{3});
  tile_object = tiledlayout(1, 2);
  ax1 = nexttile;
  box on;
  hold(ax1, 'on');
